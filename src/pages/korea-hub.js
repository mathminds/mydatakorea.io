...
import HeaderKoreaHub from '../components/HeaderKoreaHub'
import pic04 from '../assets/images/pic04.jpg'

class KoreaHub extends React.Component {
  render() {
    return (
      <Layout>
        <Helmet title="MyData Korea 허브" />
        <HeaderKoreaHub />
        <div id="main">
          <section id="content" className="main">
            <span className="image main">
            </span>
            <h2>MyData Korea 허브의 역사</h2>
            <p>
